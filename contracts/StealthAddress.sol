...
//   }
  ...
  function sendAnonymously(bytes32 x, bytes32 y, bytes1 sharedsecret, address payable receiver) public payable {
  ...
  function sendTokenAnonymously(bytes32 x, bytes32 y, bytes1 sharedsecret, address token, address receiver, uint256 amount) external {
